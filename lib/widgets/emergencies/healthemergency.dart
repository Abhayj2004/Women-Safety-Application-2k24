...
class HealthEmergency extends StatelessWidget {
  // const HealthEmergency({super.key});
          ...
          child: Container(
            ...
            child:Padding(
              ...
              child: Column(
                ...
                CircleAvatar(
                  radius: 25,
                   child: Image.asset('assets/women_logo_login.png'),
                    ...
                    child: Column(
                      children: [
                        Text('Women Helpline',style: TextStyle(
                          ...
                          Text('dial 1-0-9-1 for emergency',style: TextStyle(
